...
<Info>
**Complete and immediate.** Deletion removes both the metadata and the underlying file storage. Deleted sources cannot be fetched or have presigned URLs generated – requests return `404 SOURCE_NOT_FOUND` immediately. This ensures compliance with right-to-deletion requirements.
</Info>
