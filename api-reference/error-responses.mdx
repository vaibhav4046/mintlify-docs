...
**Source availability errors:** When fetching content, a `503` with message "Unable to verify source availability right now, please retry" indicates the system cannot verify whether the source exists. This is a transient error — retry with exponential backoff.
